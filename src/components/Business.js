...
const Business = () => {
    ...
    const getArticles = async () => {
        let api = "https://newsapi.org/v2/top-headlines?country=id&category=business&apiKey=63269bae99df4dfd964c3ce1d44b710e";
    ...
    return (
        <div>
            ...
            <div>
                <h2><center className="gb">Berita terkini dengan kaegori bisnis</center></h2>
            </div><br />
            <div className="container-fluid">
                <div className="row">
                    {

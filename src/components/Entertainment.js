...
const Entertainment = () => {
    ...
    const getArticles = async () => {
        let api = "https://newsapi.org/v2/top-headlines?country=id&category=entertainment&apiKey=63269bae99df4dfd964c3ce1d44b710e";
    ...
    return (
        <div>
            ...
            <div>
                <h2><center className="gb">Berita terkini dengan kaegori Entertainment</center></h2>
            </div><br />
            <div className="container-fluid">
                <div className="row">
                    {
